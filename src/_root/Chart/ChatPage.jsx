      ...
      <div className="bg-white bg-opacity-10 rounded-lg p-4 md:p-6 border border-gray-100 border-opacity-30">
        ...
        <div className="flex items-center mb-4 justify-between">
          ...
          <div className="mt-4 md:mt-0">
            <button className="bg-[#56EE6830] text-[#56EE68] font-medium rounded-full border border-[#56EE68] opacity-100 w-[120px] md:w-[143px] h-[37px] flex justify-center items-center text-sm md:text-base">
              Nearly 3 Days
            </button>
          </div>
        </div>

    ...
    <Suspense fallback={<LoadingFallback />}>
      <div className={`dashboard-container ${isDarkMode ? "dark" : "light"}`}>
        ...
        <div className="dashboard-content">
          <Header /> {/* Header */}
          {isMobile ? (
            <DevicesMobileView /> // Render mobile view if on a mobile device
          ) : (
            <div className="flex flex-col w-full mt-4">
              ...
              <div className="bg-white bg-opacity-10 backdrop-blur-lg border-white rounded-lg p-6 w-full shadow-lg">
                ...
                <p className="text-md">
                  Project Notes: 1. This item is the system default and cannot
                  be modified or deleted. 2. Users can put new access or
                  temporarily unallocated devices into this item.
                </p>
              </div>
            </div>
          )}
